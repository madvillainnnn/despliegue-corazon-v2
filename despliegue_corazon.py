...
.subtitulo {
    font-size: 18px; color: var(--text-color); opacity: 0.65;
    text-align: center; margin-bottom: 30px;
}

/* Tarjetas: usamos las variables de tema de Streamlit en vez de colores fijos,
   así se adaptan solas al modo claro u oscuro del usuario. */
.card {
...
.card p, .card li, .card span { color: var(--text-color) !important; opacity: 0.9; }
.card b, .card strong { color: var(--text-color) !important; opacity: 1; }

.seccion {
    color: #E53935; font-size: 25px; font-weight: bold; margin-bottom: 15px;
}

.resultado {
    background-color: rgba(183, 28, 28, 0.08);
    border-radius: 18px; padding: 30px;
    text-align: center; border: 2px solid rgba(239, 154, 154, 0.5);
    color: var(--text-color);
}
.resultado p { color: var(--text-color) !important; opacity: 0.65; }
.resultado-titulo { color: #E53935; font-size: 24px; font-weight: bold; }

.gemelo {
    background-color: rgba(120, 130, 220, 0.12);
    border-radius: 18px; padding: 20px;
    border: 2px solid rgba(150, 160, 230, 0.4);
    color: var(--text-color) !important;
}
.gemelo b { color: var(--text-color) !important; }
</style>

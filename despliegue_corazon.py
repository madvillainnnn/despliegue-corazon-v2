...
.card p, .card li, .card span { color: #333333 !important; }
.card b, .card strong { color: #111111 !important; }
.seccion {
    color: #B71C1C; font-size: 25px; font-weight: bold; margin-bottom: 15px;
}
.resultado {
    background-color: #FFF3F3; border-radius: 18px; padding: 30px;
    text-align: center; border: 2px solid #EF9A9A; color: #212121;
}
.resultado p { color: #777777 !important; }
.resultado-titulo { color: #B71C1C; font-size: 24px; font-weight: bold; }
.gemelo {
    background-color: #F5F5FF; border-radius: 18px; padding: 20px;
    border: 2px solid #C5CAE9; color: #1A1A2E !important;
}
.gemelo b { color: #1A237E !important; }
</style>
